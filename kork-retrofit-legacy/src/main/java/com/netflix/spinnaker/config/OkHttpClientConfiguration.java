...
public class OkHttpClientConfiguration {
  ...
  public OkHttpClient create()
    ...
    okHttpClient.setReadTimeout(
        okHttpClientConfigurationProperties.readTimeoutMs, TimeUnit.MILLISECONDS);
    okHttpClient.setRetryOnConnectionFailure(
        okHttpClientConfigurationProperties.retryOnConnectionFailure);
