...
public class OkHttpClientComponents {
  ...
  @Bean
  public OkHttpMetricsInterceptor okHttpMetricsInterceptor(Registry registry) {
    return new OkHttpMetricsInterceptor(registry);
  }

  @Bean
  public OkHttp3MetricsInterceptor okHttp3MetricsInterceptor(Registry registry) {
